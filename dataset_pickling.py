...
#I added this myself, because sentiment_mod crashes if you don't have the file "pickled_algos_featuresets.pickle"
#Possible save to file
featuresets = [(find_features(rev), category) for (rev, category) in documents]
save_featuresets = open("pickled_algos_featuresets.pickle", "wb")                   #Possibly delete
pickle.dump(featuresets, save_featuresets)                                          #Possibly delete
